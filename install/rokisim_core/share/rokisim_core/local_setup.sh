...
: ${AMENT_CURRENT_PREFIX:="/home/main/rokisim_ws/install/rokisim_core"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rokisim_core/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rokisim_core/environment/path.sh"
